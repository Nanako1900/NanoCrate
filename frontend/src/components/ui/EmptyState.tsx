...
export function EmptyState({ title, description, eyebrow = 'No results', action }: EmptyStateProps) {
  return (
    <div className="mx-auto flex max-w-md flex-col items-center gap-3 rounded-lg border border-dashed border-line bg-surface px-6 py-16 text-center">
      <p className="label-mono text-2xs uppercase tracking-[0.08em] text-ink-faint">{eyebrow}</p>
